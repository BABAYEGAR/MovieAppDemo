...
!function(a) {
    ...
    "function" == typeof define && define.amd
        ? define(["eve"], function(c) { return b(a, c) })
    ...
    function(a, b) {
        ...
        c.svg = !(c.vml = "VML" == c.type), c._Paper = C, c.fn = v = C.prototype = c.prototype, c._id = 0, c._oid =
            ...
            function(a) { return Math.round(180 * a / S % 360 * 1e3) / 1e3 }, c.snapTo = function(a, b, d) {
                    ...
                    for (var d = Eb(a),
                        ...
                        j = function(a, b, c, f, g) {
                            a &&
                                ...
                                "M" == a[g][0] &&
                                "M" != b[g][0] &&
                                (b.splice(g, 0, ["M", f.x, f.y]), c.bx = 0, c.by = 0, c.x = a[g][1], c.y = a[g][2], p =
                        ...
                        p > o;
                        o++) {
                        d[o] && (m = d[o][0]), "C" != m && (k[o] = m, o && (n = k[o - 1])), d[o] =
                                h(d[o], f, n), "A" != k[o] && "C" == m && (k[o] = "C"), i(d, o), e &&
                            (e[o] && (m = e[o][0]), "C" != m && (l[o] = m, o && (n = l[o - 1])), e[o] =
                                h(e[o], g, n), "A" != l[o] && "C" == m && (l[o] = "C"), i(e, o)), j(d, e, f, g, o),
                            j(e, d, g, f, o);
                        var q = d[o], r = e && e[o], s = q.length, t = e && r.length;
                        f.x = q[s - 2], f.y = q[s - 1], f.bx = _(q[s - 4]) || f.x, f.by = _(q[s - 3]) || f.y, g.bx =
                            e && (_(r[t - 4]) || g.x), g.by = e && (_(r[t - 3]) || g.y), g.x = e && r[t - 2], g.y =
                            e && r[t - 1]
                    }
        ...
        return nc.attr = function(a, b) {
            ...
            nc.animate = function(a, b, d, e) {
                ...
                nc, b.on("raphael.DOMload", function() { u = !0 }), function(a, b, d) {
                                ...
                                if (f[a](o)) {
                                    ...
                                    case"stroke-width":
                                        (1 != d._.sx || 1 != d._.sy) && (p /= g(h(d._.sx), h(d._.sy)) || 1),
                                            i.setAttribute(o, p), k["stroke-dasharray"] &&
                        ...
                        B.show =
                            ...
                            if (!this.removed && a.parentNode) {
                                ...
                                b.__set__ && b.__set__.exclude(this), k.unbind("raphael.*.*." + this.id),
                                    this.gradient &&
                                        b.defs.removeChild(this.gradient), c._tear(this, b),
                                    a.parentNode.removeChild(a), this
                                        .removeData();
                                for (var d in this)
                            ...
                            this.paper.canvas.parentElement
                                ...
                                : this.paper.canvas.parentNode && (b = this.paper.canvas.parentNode.style), b &&
                                "none" == b.display &&
                                (c = !0, b.display = "");
                            var d = {};
                            try {
                ...
                if (c.vml) {
                        ...
                        B = function(e, i) {
                            ...
                            if (q && (m.path = c._getPath[e.type](e), e._.dirty = 1), i.href && (l.href = i.href),
                                ...
                                i.cursor && (p.cursor = i.cursor), "blur" in i && e.blur(i.blur), (
                                    ...
                                    (l.path =
                                        x(~b(m.path).toLowerCase().indexOf("r") ? c._pathToAbsolute(m.path) : m.path), e
                                        ._.dirty =
                                        1, "image" == e.type &&
                    ...
                    D.prototype = E, E.constructor = D, E.transform = function(a) {
                        ...
                        function() { return!this.removed && (this.node.style.display = o), this }, E.auxGetBBox =
                        c.el.getBBox, E.getBBox = function() {
                        var a = this.auxGetBBox();
                        if (this.paper && this.paper._viewBoxShift) {
                            var b = {}, c = 1 / this.paper._viewBoxShift.scale;
                            return b.x = a.x - this.paper._viewBoxShift.dx, b.x *= c, b.y =
                                a.y - this.paper._viewBoxShift.dy, b.y *= c, b.width = a.width * c, b.height =
                                a.height * c, b.x2 = b.x + b.width, b.y2 = b.y + b.height, b
                        }
                        return a
                    }, E._getBBox =
                        function() {

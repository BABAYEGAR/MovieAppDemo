(function(factory) {
    ...
    var DataBasicPlugin = function(context) {
        ...
        context.memo("button.databasicDialog",
            function() {
                return ui.button({
                    contents: self.icon,
        ...
        context.memo("button.databasicSize100",
            function() {
                return ui.button({
        ...
        context.memo("button.databasicSize25",
            function() {
                return ui.button({
        ...
        self.initialize = function() {
            ...
            var body = '<div class="form-group row-fluid">' +
                ...
                "</div>";
            var footer = '<button href="#" class="btn btn-primary ext-databasic-save">' +
        ...
        self.setContent = function($node) {
            $node.html('<p contenteditable="false">' +
                self.icon +
                " " +
                lang.databasic.name +
                ": " +
